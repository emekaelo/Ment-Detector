...
<body>
    ...
    <div class="service">
        ...
        <div><svg width="85" height="60" viewBox="0 0 85 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M25.8804 30.1118C34.4857 30.1118 40.9774 23.6378 40.9774 15.0559C40.9774 6.47405 34.4857 0 25.8804 0C17.2752 0 10.7835 6.47405 10.7835 15.0559C10.7835 23.6378 17.2752 30.1118 25.8804 30.1118ZM30.1939 34.1898H21.567C9.67497 34.1898 0 43.8385 0 55.6983V60H51.7609V55.6983C51.7609 43.8385 42.0859 34.1898 30.1939 34.1898ZM78.9095 13.9375L60.3618 32.4003L54.7889 26.8426L48.6897 32.9252L60.3618 44.5569L85 20.0287L78.9095 13.9375Z" fill="#6C63FF" />
            </svg>
            <h4>Easy To Use</h4>
            <hr>
    ...
    <div class="row" id="default-demo">
        <div class="col-xs-4"><a href="img/MentDetector Moblie Page 1.png" data-caption="" target="_blank" class="thumbnail"><img src="img/MentDetector Moblie Page 1.png" alt="" class="img-thumbnail"></a></div>
        <div class="col-xs-4"><a href="img/MentDetector Moblie Page 2.png" data-caption="" target="_blank" class="thumbnail"><img src="img/MentDetector Moblie Page 2.png" alt="" class="img-thumbnail"></a></div>
        <div class="col-xs-4"><a href="img/MentDetector Moblie Page 3.png" data-caption="" target="_blank" class="thumbnail"><img src="img/MentDetector Moblie Page 3.png" alt="" class="img-thumbnail"></a></div>
        <div class="col-xs-4"><a href="img/MentDetector Moblie Page 4.png" data-caption="" target="_blank" class="thumbnail"><img src="img/MentDetector Moblie Page 4.png" alt="" class="img-thumbnail"></a></div>
        <div class="col-xs-4"><a href="img/MentDetector Moblie Page 5.png" data-caption="" target="_blank" class="thumbnail"><img src="img/MentDetector Moblie Page 5.png" alt="" class="img-thumbnail"></a></div>
    ...
    <footer>
        ...
        <div class="form-container lastform">
            ...
            <?php if (isset($email_error)) {
                echo /*"<div class='server-output'>" .*/ $email_error /*. "</div>"*/;
            }
            ?>
